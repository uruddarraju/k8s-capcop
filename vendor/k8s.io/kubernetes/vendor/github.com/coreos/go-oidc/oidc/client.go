...
type ClientMetadata struct {
	...
	ClientName string
	// URL that references a logo for the DefaultClient application.
	LogoURI *url.URL
	// URL of the home page of the DefaultClient.
	ClientURI *url.URL
	...
	// DefaultClient requested authorization method and signing options for the token endpoint.
	//
...
// public key from the DefaultClient that matches the provided ID
