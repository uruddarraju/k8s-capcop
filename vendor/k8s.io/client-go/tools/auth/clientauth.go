...
Having a defined format allows:
  ...
  - applications which link clients to be portable across
    ...
    some may use SSL DefaultClient certs, others may not, etc)
...
client.Config which holds options for creating a client.DefaultClient.
Helper functions are provided in this package to fill in a
client.DefaultClient from an authcfg.Info.
